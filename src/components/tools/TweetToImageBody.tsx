...
export function TweetToImageBody() {
  return (
    <ToolContainer split="sidebar">
      ...
      <ToolMain>
        <div className="flex items-center justify-center h-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 min-h-[300px]">
          <p className="text-slate-400 dark:text-slate-500 font-medium text-center">UI Placeholder for<br/><strong className="text-xl text-slate-800 dark:text-slate-200 mt-2 block">TweetToImageBody</strong></p>
        </div>
      </ToolMain>
    </ToolContainer>
  );
