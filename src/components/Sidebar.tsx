  ...
  return (
    <>
      ...
      <div className="border-t border-border-subtle">
        <a href="/bookmarksoft-extension.zip" download="bookmarksoft-extension.zip" className="flex items-center gap-4 px-6 py-5 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group cursor-pointer">
